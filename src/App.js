        ...
        if (measurement_constituted === 0 && coins_on_scale_now > 0 && this.coin_locations !== coin_locations_now) {
            if ((Math.abs(this.coin_location_array[number_of_coins]) === 1 || Math.abs(this.coin_location_array[number_of_coins + 1]) === 1) && coins_on_scale_now === 2) {
                if (this.state.balanced === 0) {
                    ...
                    TweenLite.to("#scale_icon" + (this.measurementsUsed - 1), .5, {
                        autoAlpha: 0.2,
                        ease: Power3.easeOut
                    });
...
////////////////////////////////////////////////////////////////////////////////////////
    ...
    coins_3 = () => {
        this.state.coin_num = 3;
        this.reset_game(3)
    }
    coins_6 = () => {
        this.state.coin_num = 6;
        this.reset_game(6)
    }
    coins_9 = () => {
        this.state.coin_num = 9;
        this.reset_game(9)
    }
    coins_10 = () => {
        this.state.coin_num = 10;
        this.reset_game(10)
    }
    coins_11 = () => {
        this.state.coin_num = 11;
        this.reset_game(11)
    }
    coins_12 = () => {
        this.state.coin_num = 12;
        this.reset_game(12)
    }
    coins_13 = () => {
        this.state.coin_num = 13;
        this.reset_game(13)
    }
    coins_14 = () => {
        this.state.coin_num = 14;
        this.reset_game(14)
    }
    coins_15 = () => {
        this.state.coin_num = 15;
        this.reset_game(15)
    }
    reset_game = (numbr) => {
    ...
    render_coins() {
        return <Coins ref={(child) => {
            this._child = child;
        }} label={this.state.labels} numberOfCoins={this.state.coin_num} id="set_of_coins"
                      balance_func={this.balance_scale}  replace_fn={this.replace_coins}   />;
    }

    render_nav() {
        return <Nav className="nav" coins_3_fn={this.coins_3} coins_6_fn={this.coins_6} coins_9_fn={this.coins_9}
